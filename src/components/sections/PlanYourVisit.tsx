        ...
        <div className="grid gap-12 md:grid-cols-2 md:gap-16">
          <div>
            ...
            <p className="mt-4 max-w-md text-base text-muted-foreground md:text-lg">
              Tell us a little about you and we'll look out for you when you visit. No pressure,
              no long forms, no follow-up sales pitch.
            </p>
            ...
            {submitted ? (
              <div className="flex h-full min-h-[360px] flex-col items-center justify-center text-center">
                ...
                <p className="mt-2 max-w-sm text-sm text-muted-foreground">
                  Someone from our team will reach out with a friendly note before you come.
              ...
              <form onSubmit={onSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <input
                    id="when" name="when" type="text" placeholder="This Saturday, next weekend, not sure yet…"
                    className="mt-1.5 block w-full rounded-md border border-input bg-background px-3 py-2.5 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-ring"
                  />
